...
node{
        ...
        stage('Remote SSH') {
            ...
            sshCommand remote: remote, command: "'bash -s' < C:/Users/Solo de Zaldivar/Documents/HS20/cps/test_scenarios/Master-Thesis-CPS-SORTER/RQ1/test/bash.sh"
            // sshCommand remote: remote, command: "source Documents/FuegoGroup/cps/CPS-SORTER/venv/bin/activate\ncps_sorter run-model-eval -i  < C:/Users/Solo de Zaldivar/Documents/HS20/cps/test_scenarios/Master-Thesis-CPS-SORTER/RQ1/Full Road/BeamNG/BeamNG_RF_1_5/beamng_risk_1.5"
